<template lang="pug">
  section.about
    .authorization
      .auth__wrapper
        .auth__window
          h2.auth__header Authorization
          button.close-window
          form.auth__form(action='')
            label.form__block(for='') 
              .form-label Login
              .form-input__wrapper-login
                input.auth__form-input(name='auth' type='login' placeholder="terry_tao" required)
            label.form__block(for='') 
              .form-label Password
              .form-input__wrapper-password
                input.auth__form-input(name='password' type='password' placeholder="*******" required)
            .auth__form-button__wrapper
              input.auth__form-button(type='submit') 
    header.header
      .container.header__container
          .header__content
            .header__logo 
              img(src="../images/content/user.jpeg" class="header__logo-img")
    ...
    nav.nav 
      .container.nav__container
        - var navList = ["About", "Papers", "Quotes"]
          ul.nav__list
    ...
    .container.about__container
      .about__content
        .content-header
          ...
          .add-group
            .add-group__wrapper
              button.add-group__icon(name='add-group__icon')
            button.add-group__button(name='add-group__button') Add group
        .about__groups
          .group
            ...
            .current-paper
              .current-paper__content
                .current-paper__photo
                  img(src="../images/content/sum_product.jpg" class="current-paper-img")
                .current-paper__description
                  .current-paper__title A sum-product estimate in finite fields, and applications
          ...
          .current-quote
            .current-quote__content
              .quote__author-content
                .quote__author-photo
                  img(src="../images/content/timothy.jpeg" class="quote__author-img")
                .quote__author-text
